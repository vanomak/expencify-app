...
export class ExpenceListFilters extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <input type="text" value={props.filters.text} onChange={this.onTextChange} />
                <select value={props.filters.sortBy} onChange={this.onSortChange}>
...
const mapDispatchToProps = (dispatch) => ({
    setTextFilter: (text) => dispatch(setTextFilter(e.target.value)),
